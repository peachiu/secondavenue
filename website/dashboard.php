...
<body>
    ...
    <nav class="navbar navbar-expand-lg border-bottom px-4" style="margin-top: 0; border-radius: 0; width: 100%; max-width: 100%; background: white;">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3">
                <div class="card p-4 text-center">
                    <div class="mb-3">
                        <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center text-primary" style="width: 80px; height: 80px;">
                    ...
                    <div class="text-start">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold">0</span><!-- Placeholder -->
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            <td class="ps-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bold text-dark"><?= htmlspecialchars($listing['title']) ?></span>
                                                </div>
                                            </td>
